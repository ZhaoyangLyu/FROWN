...
class FcNetGeneralActivationBatchwiseOpt(fcNet):
    ...
    def clear_intermediate_variables(self):
        super(FcNetGeneralActivationBatchwiseOpt, self).clear_intermediate_variables()
    ...
    def optimize_k_batchwise(self, v, eps, p, x, num_neurons, max_iter = 100, print_loss=True,
        ...
        # we should instead use optimize_k_batchwise_for_last_layer_with_gx0_trick_multi_sample
    ...
    def optimize_last_layer_bound(self,  eps, p, x, max_iter, print_loss, gx0_trick, targeted, save_dir=None):
        ...
        for v in range(1, self.num_layers): # v from 1 to self.num_layers-1
            yL,yU = self.optimize_k_batchwise( v, eps, p, x, self.num_neurons[v-1], max_iter = max_iter, 
        ...
        if gx0_trick:
            ...
            yL,yU = self.optimize_k_batchwise( self.num_layers, eps, p, x, self.output_dimension, 
                            max_iter = max_iter, print_loss = print_loss)
        return yL,yU
